...
$$
\begin{align}
\w(X) & = x_5 \cdot l_1(X)+x_1 \cdot l_2(X) +x_3 \cdot l_3(X) & \\ & = x_5 \cdot \frac{(X-2)(X-3)}{2} - x_1 \cdot(X-1)(X-3)+x_3 \cdot\frac{(X-1)(X-2)}{2}
\end{align}
$$
...
<img src="/ZKP-PLONK/images/polish「2」/插值多项式构造过程.png" width="20%" />
