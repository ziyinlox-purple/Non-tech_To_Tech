...
我们可以把这个等式变换一下，变成 $k_1 = k_2 \cdot \omega{j-i}$。

因为 $\omega{j-i}$ 是 $H$ 中的元素，而 $H_2 = k_2 \cdot H$，根据 $k_1 = k_2 \cdot \omega{j-i}$， $H_2$ 由 $k_2 \cdot H$ 生成，可以得出 $k_1$ 是 $H_2$ 的一个元素，即 $k_1\in H_2$。
...
<img src="/ZKP-PLONK/images/「4」置换证明和拷贝约束/协议框架.png" width="80%" />
「图：协议框架」
