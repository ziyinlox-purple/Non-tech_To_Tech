...
![图1：电路1](../images/PLONK算术化「1」/图：电路1.png)
...
![图2-约束关系](../images/PLONK算术化「1」/图2:约束关系.png)
...
![图3:矩阵 $W\in\mathbb{F}^{n\times 3}$](../images/PLONK算术化「1」/图3.png)
...
![计算过程1-1.png](../images/PLONK算术化「1」/计算过程1-1.png)
...
![计算过程1-2.png](../images/PLONK算术化「1」/计算过程1-2.png)
...
![图4:矩阵 $Q\in\mathbb{F}^{n\times5}$](../images/PLONK算术化「1」/图4.png)
...
![图5:矩阵 $Q$、$W$ 代入固定等式](../images/PLONK算术化「1」/图5.png)
...
![图6:化简过程](../images/PLONK算术化「1」/图6:化简过程.png)


![图7:化简后](../images/PLONK算术化「1」/图7:化简后.png)
...
![图8:电路比较](../images/PLONK算术化「1」/图8:电路比较.png)
...
![图10：新的约束关系](../images/PLONK算术化「1」/图10：新的约束关系.png)
...
![图11:$\sigma$ 向量](../images/PLONK算术化「1」/图11.png)
